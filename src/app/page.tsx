    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          things I&apos;ve found interesting recently. I&apos;m particularly interested in AI's impact on society and the economy. 
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
          I also love listening to a lot of different music — here are some of my <a href="https://open.spotify.com/playlist/397Pe2OwOWcw23F3CBCMle?si=a61e85a4ec754bd9" className="underline hover:text-gray-900">favorite EDM songs</a> and <a href="https://open.spotify.com/playlist/33Q5JaW4rWtLWxQsUD6yvS?si=320c953915b34d28" className="underline hover:text-gray-900">favorite soundtracks</a>.
        </p>
        <p className="text-gray-700 leading-relaxed">
          Feel free to reach out at <a href="mailto:shiva.123.menta@gmail.com" className="underline hover:text-gray-900">shiva.123.menta@gmail.com</a>.
        </p>
      </section>
    </div>
  );
